    ...
    try {
      ...
      if (result.isSuccess) {
        ...
        if (result.status == "pending_verification") {
          event.context.push('/verify-screen');
          ...
          if (isIOS) {
            showCupertinoDialog(
              ...
              builder: (context) => CupertinoAlertDialog(
                ...
                content: Text('Login failed, Please try again. new '),
                actions: [
            ...
            ScaffoldMessenger.of(event.context).showSnackBar(
              SnackBar(
                content: Text('Login failed. Please try again.error'),
      ...
      Future.microtask(() {
        ...
        if (isIOS) {
          showCupertinoDialog(
            ...
            builder: (context) => CupertinoAlertDialog(
              title: Text('Login Failed'),
              content: Text('Login failed. Please try again. rr'),
              actions: [
                CupertinoDialogAction(
                  child: Text('OK'),
                  onPressed: () => Navigator.of(context).pop(),
